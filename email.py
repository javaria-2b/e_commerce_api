...
async def send_email(email : list, instance: User):
    ...
    template = f"""
        ...
        <body>
            <div style="display: flex; align-items: center; justify-content: center; flex-direction: column;">
                ...
                <br>
                <p>Thanks for choosing CHERRYmeaow, please 
                click on the link below to verify your account bootiful</p> 
                ...
                <p style="margin-top:1rem;">If you did not register for CHERRYmeaow, 
    ...
    message = MessageSchema(
        subject = "CHERRYmeaow Account Verification Mail",
